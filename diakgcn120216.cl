...
//----------------------------------------------------------------------------------
	...
	V[1] += 0x4d2c6dfc + V[5] + W[0] + ch(34) + rotr26(V[2]);
	V[5] =  0x4d2c6dfc + V[5] + W[0] + ch(34) + rotr26(V[2]) + rotr30(V[6]) + ma(34);

	V[0] += 0x53380d13 + V[4] + W[1] + ch(35) + rotr26(V[1]);
	V[4] =  0x53380d13 + V[4] + W[1] + ch(35) + rotr26(V[1]) + rotr30(V[5]) + ma(35);

	V[7] += 0x650a7354 + V[3] + W[2] + ch(36) + rotr26(V[0]);
	V[3] =  0x650a7354 + V[3] + W[2] + ch(36) + rotr26(V[0]) + rotr30(V[4]) + ma(36);

	V[6] += 0x766a0abb + V[2] + W[3] + ch(37) + rotr26(V[7]);
	V[2] =  0x766a0abb + V[2] + W[3] + ch(37) + rotr26(V[7]) + rotr30(V[3]) + ma(37);

	V[5] += 0x81c2c92e + V[1] + W[4] + ch(38) + rotr26(V[6]);
	V[1] =  0x81c2c92e + V[1] + W[4] + ch(38) + rotr26(V[6]) + rotr30(V[2]) + ma(38);

	V[4] += 0x92722c85 + V[0] + W[5] + ch(39) + rotr26(V[5]);
	V[0] =  0x92722c85 + V[0] + W[5] + ch(39) + rotr26(V[5]) + rotr30(V[1]) + ma(39);

	V[3] += 0xa2bfe8a1 + V[7] + W[6] + ch(40) + rotr26(V[4]);
	V[7] =  0xa2bfe8a1 + V[7] + W[6] + ch(40) + rotr26(V[4]) + rotr30(V[0]) + ma(40);

	V[2] += 0xa81a664b + V[6] + W[7] + ch(41) + rotr26(V[3]);
	V[6] =  0xa81a664b + V[6] + W[7] + ch(41) + rotr26(V[3]) + rotr30(V[7]) + ma(41);

	V[1] += 0xc24b8b70 + V[5] + W[8] + ch(42) + rotr26(V[2]);
	V[5] =  0xc24b8b70 + V[5] + W[8] + ch(42) + rotr26(V[2]) + rotr30(V[6]) + ma(42);

	V[0] += 0xc76c51a3 + V[4] + W[9] + ch(43) + rotr26(V[1]);
	V[4] =  0xc76c51a3 + V[4] + W[9] + ch(43) + rotr26(V[1]) + rotr30(V[5]) + ma(43);

	V[7] += 0xd192e819 + V[3] + W[10] + ch(44) + rotr26(V[0]);
	V[3] =  0xd192e819 + V[3] + W[10] + ch(44) + rotr26(V[0]) + rotr30(V[4]) + ma(44);

	V[6] += 0xd6990624 + V[2] + W[11] + ch(45) + rotr26(V[7]);
	V[2] =  0xd6990624 + V[2] + W[11] + ch(45) + rotr26(V[7]) + rotr30(V[3]) + ma(45);

	V[5] += 0xf40e3585 + V[1] + W[12] + ch(46) + rotr26(V[6]);
	V[1] =  0xf40e3585 + V[1] + W[12] + ch(46) + rotr26(V[6]) + rotr30(V[2]) + ma(46);

	V[4] += 0x106aa070 + V[0] + W[13] + ch(47) + rotr26(V[5]);
	V[0] =  0x106aa070 + V[0] + W[13] + ch(47) + rotr26(V[5]) + rotr30(V[1]) + ma(47);

	V[3] += 0x19a4c116 + V[7] + W[14] + ch(48) + rotr26(V[4]);
	V[7] =  0x19a4c116 + V[7] + W[14] + ch(48) + rotr26(V[4]) + rotr30(V[0]) + ma(48);

	V[2] += 0x1e376c08 + V[6] + W[15] + ch(49) + rotr26(V[3]);
	V[6] =  0x1e376c08 + V[6] + W[15] + ch(49) + rotr26(V[3]) + rotr30(V[7]) + ma(49);
...
//----------------------------------------------------------------------------------
	...
	V[1] += 0x2748774c + V[5] + W[0] + ch(50) + rotr26(V[2]);
	V[5] =  0x2748774c + V[5] + W[0] + ch(50) + rotr26(V[2]) + rotr30(V[6]) + ma(50);

	V[0] += 0x34b0bcb5 + V[4] + W[1] + ch(51) + rotr26(V[1]);
	V[4] =  0x34b0bcb5 + V[4] + W[1] + ch(51) + rotr26(V[1]) + rotr30(V[5]) + ma(51);

	V[7] += 0x391c0cb3 + V[3] + W[2] + ch(52) + rotr26(V[0]);
	V[3] =  0x391c0cb3 + V[3] + W[2] + ch(52) + rotr26(V[0]) + rotr30(V[4]) + ma(52);

	V[6] += 0x4ed8aa4a + V[2] + W[3] + ch(53) + rotr26(V[7]);
	V[2] =  0x4ed8aa4a + V[2] + W[3] + ch(53) + rotr26(V[7]) + rotr30(V[3]) + ma(53);

	V[5] += 0x5b9cca4f + V[1] + W[4] + ch(54) + rotr26(V[6]);
	V[1] =  0x5b9cca4f + V[1] + W[4] + ch(54) + rotr26(V[6]) + rotr30(V[2]) + ma(54);

	V[4] += 0x682e6ff3 + V[0] + W[5] + ch(55) + rotr26(V[5]);
	V[0] =  0x682e6ff3 + V[0] + W[5] + ch(55) + rotr26(V[5]) + rotr30(V[1]) + ma(55);

	V[3] += 0x748f82ee + V[7] + W[6] + ch(56) + rotr26(V[4]);
	V[7] =  0x748f82ee + V[7] + W[6] + ch(56) + rotr26(V[4]) + rotr30(V[0]) + ma(56);

	V[2] += 0x78a5636f + V[6] + W[7] + ch(57) + rotr26(V[3]);
	V[6] =  0x78a5636f + V[6] + W[7] + ch(57) + rotr26(V[3]) + rotr30(V[7]) + ma(57);

	V[1] += 0x84c87814 + V[5] + W[8] + ch(58) + rotr26(V[2]);
	V[5] =  0x84c87814 + V[5] + W[8] + ch(58) + rotr26(V[2]) + rotr30(V[6]) + ma(58);

	V[0] += 0x8cc70208 + V[4] + W[9] + ch(59) + rotr26(V[1]);
	V[4] =  0x8cc70208 + V[4] + W[9] + ch(59) + rotr26(V[1]) + rotr30(V[5]) + ma(59);

	V[7] += 0x90befffa + V[3] + W[10] + ch(60) + rotr26(V[0]);
	V[3] =  0x90befffa + V[3] + W[10] + ch(60) + rotr26(V[0]) + rotr30(V[4]) + ma(60);

	V[6] += 0xa4506ceb + V[2] + W[11] + ch(61) + rotr26(V[7]);
	V[2] =  0xa4506ceb + V[2] + W[11] + ch(61) + rotr26(V[7]) + rotr30(V[3]) + ma(61);

	V[5] += 0xbef9a3f7 + V[1] + W[12] + ch(62) + rotr26(V[6]);
	V[1] =  0xbef9a3f7 + V[1] + W[12] + ch(62) + rotr26(V[6]) + rotr30(V[2]) + ma(62);

	V[4] += 0xc67178f2 + V[0] + W[13] + ch(63) + rotr26(V[5]);
	V[0] =  0xc67178f2 + V[0] + W[13] + ch(63) + rotr26(V[5]) + rotr30(V[1]) + ma(63);
...
//----------------------------------------------------------------------------------
	...
	V[3] += 0x27b70a85 + V[7] + W[0] + ch(96) + rotr26(V[4]);
	V[7] =  0x27b70a85 + V[7] + W[0] + ch(96) + rotr26(V[4]) + rotr30(V[0]) + ma(96);

	V[2] += 0x2e1b2138 + V[6] + W[1] + ch(97) + rotr26(V[3]);
	V[6] =  0x2e1b2138 + V[6] + W[1] + ch(97) + rotr26(V[3]) + rotr30(V[7]) + ma(97);

	V[1] += 0x4d2c6dfc + V[5] + W[2] + ch(98) + rotr26(V[2]);
	V[5] =  0x4d2c6dfc + V[5] + W[2] + ch(98) + rotr26(V[2]) + rotr30(V[6]) + ma(98);

	V[0] += 0x53380d13 + V[4] + W[3] + ch(99) + rotr26(V[1]);
	V[4] =  0x53380d13 + V[4] + W[3] + ch(99) + rotr26(V[1]) + rotr30(V[5]) + ma(99);

	V[7] += 0x650a7354 + V[3] + W[4] + ch(100) + rotr26(V[0]);
	V[3] =  0x650a7354 + V[3] + W[4] + ch(100) + rotr26(V[0]) + rotr30(V[4]) + ma(100);

	V[6] += 0x766a0abb + V[2] + W[5] + ch(101) + rotr26(V[7]);
	V[2] =  0x766a0abb + V[2] + W[5] + ch(101) + rotr26(V[7]) + rotr30(V[3]) + ma(101);

	V[5] += 0x81c2c92e + V[1] + W[6] + ch(102) + rotr26(V[6]);
	V[1] =  0x81c2c92e + V[1] + W[6] + ch(102) + rotr26(V[6]) + rotr30(V[2]) + ma(102);

	V[4] += 0x92722c85 + V[0] + W[7] + ch(103) + rotr26(V[5]);
	V[0] =  0x92722c85 + V[0] + W[7] + ch(103) + rotr26(V[5]) + rotr30(V[1]) + ma(103);

	V[3] += 0xa2bfe8a1 + V[7] + W[8] + ch(104) + rotr26(V[4]);
	V[7] =  0xa2bfe8a1 + V[7] + W[8] + ch(104) + rotr26(V[4]) + rotr30(V[0]) + ma(104);

	V[2] += 0xa81a664b + V[6] + W[9] + ch(105) + rotr26(V[3]);
	V[6] =  0xa81a664b + V[6] + W[9] + ch(105) + rotr26(V[3]) + rotr30(V[7]) + ma(105);

	V[1] += 0xc24b8b70 + V[5] + W[10] + ch(106) + rotr26(V[2]);
	V[5] =  0xc24b8b70 + V[5] + W[10] + ch(106) + rotr26(V[2]) + rotr30(V[6]) + ma(106);

	V[0] += 0xc76c51a3 + V[4] + W[11] + ch(107) + rotr26(V[1]);
	V[4] =  0xc76c51a3 + V[4] + W[11] + ch(107) + rotr26(V[1]) + rotr30(V[5]) + ma(107);

	V[7] += 0xd192e819 + V[3] + W[12] + ch(108) + rotr26(V[0]);
	V[3] =  0xd192e819 + V[3] + W[12] + ch(108) + rotr26(V[0]) + rotr30(V[4]) + ma(108);

	V[6] += 0xd6990624 + V[2] + W[13] + ch(109) + rotr26(V[7]);
	V[2] =  0xd6990624 + V[2] + W[13] + ch(109) + rotr26(V[7]) + rotr30(V[3]) + ma(109);

	V[5] += 0xf40e3585 + V[1] + W[14] + ch(110) + rotr26(V[6]);
	V[1] =  0xf40e3585 + V[1] + W[14] + ch(110) + rotr26(V[6]) + rotr30(V[2]) + ma(110);

	V[4] += 0x106aa070 + V[0] + W[15] + ch(111) + rotr26(V[5]);
	V[0] =  0x106aa070 + V[0] + W[15] + ch(111) + rotr26(V[5]) + rotr30(V[1]) + ma(111);
